...
public class DTDSerializer
{
   ...
   private void writeEnumeration(Vector enumm, boolean isNotation)
      throws IOException
   {
      if (isNotation)
      {
      ...
      writer.write(GROUPSTART);
      writer.write(((String)enumm.elementAt(0)));
      for (int i = 1; i < enumm.size(); i++)
      {
         writer.write(CHOICESEPARATOR);
         writer.write(((String)enumm.elementAt(i)));
      }
      writer.write(GROUPEND);
   }
