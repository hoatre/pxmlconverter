...
class Tokenize
{
	public static void main(String[] args)
	{
		try
		{
            ...
            if (args.length == 0) {
            	System.out.println("Geef DTD mee als argument");
            	System.exit(0);
            }
...
// Parse the DTD and ask the parser to guess the root element
            ...
            Enumeration e = dtd.getElements().elements();
            ...
            while (e.hasMoreElements())
            {
                ...
                if (elem.attributes.size() > 0)
                {
                    ...
                    while (attrs.hasMoreElements())
                    {
                        ...
                        //System.out.println("attr.naam: "+attr.name+" attr.value: "+attr.getDefaultValue() +" attr.decl: "+attr.decl +"toString: " +attr.toString());
                        dumpAttribute(attr);
                    }
                    System.out.println();
                }
